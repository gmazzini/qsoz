...
static const char qsoz_page[]=
  ...
  "      <button class=\"btn\" id=\"a32\">CTY</button><button class=\"btn\" id=\"a33\" hidden>Completion</button><br>\n"
  ...
  "  if (btn.id === \"a32\" || btn.id === \"a33\") {\n"
  "    btn.addEventListener(\"click\", async () => {\n"
  "      const out = document.getElementById(\"out2\");\n"
  "      const endpoint = btn.id === \"a32\" ? \"qsoz?op=cty\" : \"qsoz?op=completion\";\n"
  "      out.textContent = \"Waiting\";\n"
  "      const r = await fetch(endpoint, {\n"
  "        method: \"POST\", cache: \"no-store\", credentials: \"same-origin\",\n"
  "        headers: {\"Content-Type\": \"text/plain\"}, body: ota\n"
  "      });\n"
